 ...
 * @see get_post_type_labels() for label keys.
 */
function toilet_case_init() {
    $labels = array(
        'name'                  => _x( 'Cases', 'Post type general name', 'toilet' ),
        'singular_name'         => _x( 'Case', 'Post type singular name', 'toilet' ),
        'menu_name'             => _x( 'Cases', 'Admin Menu text', 'toilet' ),
        'name_admin_bar'        => _x( 'Case', 'Add New on Toolbar', 'toilet' ),
        'add_new'               => __( 'Add New', 'toilet' ),
        'add_new_item'          => __( 'Add New Case', 'toilet' ),
        'new_item'              => __( 'New Case', 'toilet' ),
        'edit_item'             => __( 'Edit Case', 'toilet' ),
        'view_item'             => __( 'View Case', 'toilet' ),
        'all_items'             => __( 'All Cases', 'toilet' ),
        'search_items'          => __( 'Search Cases', 'toilet' ),
        'parent_item_colon'     => __( 'Parent Cases:', 'toilet' ),
        'not_found'             => __( 'No cases found.', 'toilet' ),
        'not_found_in_trash'    => __( 'No cases found in Trash.', 'toilet' ),
        'featured_image'        => _x( 'Case Cover Image', 'Overrides the “Featured Image” phrase for this post type. Added in 4.3', 'toilet' ),
        'set_featured_image'    => _x( 'Set cover image', 'Overrides the “Set featured image” phrase for this post type. Added in 4.3', 'toilet' ),
        'remove_featured_image' => _x( 'Remove cover image', 'Overrides the “Remove featured image” phrase for this post type. Added in 4.3', 'toilet' ),
        'use_featured_image'    => _x( 'Use as cover image', 'Overrides the “Use as featured image” phrase for this post type. Added in 4.3', 'toilet' ),
        'archives'              => _x( 'Case archives', 'The post type archive label used in nav menus. Default “Post Archives”. Added in 4.4', 'toilet' ),
        'insert_into_item'      => _x( 'Insert into case', 'Overrides the “Insert into post”/”Insert into page” phrase (used when inserting media into a post). Added in 4.4', 'toilet' ),
        'uploaded_to_this_item' => _x( 'Uploaded to this case', 'Overrides the “Uploaded to this post”/”Uploaded to this page” phrase (used when viewing media attached to a post). Added in 4.4', 'toilet' ),
        'filter_items_list'     => _x( 'Filter cases list', 'Screen reader text for the filter links heading on the post type listing screen. Default “Filter posts list”/”Filter pages list”. Added in 4.4', 'toilet' ),
